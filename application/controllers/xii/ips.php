...
class Ips extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('xii/Action_ips');
    ...
    public function geografi()
    {
        $data['title']  = 'Geografi';
        $data['user']   = $this->Action_model->queryAkun();
        # SISWA geografi KELAS 12
        $data['siswa'] = $this->Action_ips->geografi();
        $this->load->view('template/header.php', $data);
        $this->load->view('template/sidebar.php', $data);
        $this->load->view('template/topbar.php', $data);
        $this->load->view('kelas/xii/ips/geografi.php', $data);
        $this->load->view('template/footer.php');
    }
    ...
    public function sosiologi()
    {
        ...
        $data['user']   = $this->Action_model->queryAkun();
        # SISWA sosiologi KELAS 12
        $data['siswa'] = $this->Action_ips->sosiologi();
        $this->load->view('template/header.php', $data);
        $this->load->view('template/sidebar.php', $data);
        $this->load->view('template/topbar.php', $data);
        $this->load->view('kelas/xii/ips/sosiologi.php', $data);
        $this->load->view('template/footer.php');
    }


    /* ============================ Konfirmasi Absen Pelajaran : Kelas XII 12 ===================================*/
